        ...
        <div class="container mb-5">
            ...
            <section class="customer-logos slider">
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/blog1.jpg')}});"></div>
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/blog2.jpg')}});"></div>
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/blog3.jpg')}});"></div>
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/team1.jpg')}});"></div>
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/team2.jpg')}});"></div>
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/team3.jpg')}});"></div>
                <div class="slide" style="height: 100px ;background: url({{ asset('assets/image/team5.jpg')}});"></div>
            </section>

...
<html lang="en">
    <head>
        ...
        <title>Mauvaise passerelle</title>
        <!-- Bootstrap CSS -->
    ...
    <div class="error">
        <div class="container-floud">
            <div class="col-xs-12 ground-color text-center" style="background-color: #f9f9ff">
                ...
                <h2 class="h1">Désolé! Mauvaise passerelle</h2>
